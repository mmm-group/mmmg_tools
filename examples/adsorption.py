...
molecule.rotate_sites(theta=np.deg2rad(
    90 - poscar.structure.lattice.gamma), axis=[0, 0, 1])
...
angle = poscar.structure._sites[128].coords - \
    poscar.structure._sites[259].coords

# Add the adsorbate
poscar.add_adsorbate(
    molecule, site[0], height=2.1, mirror_site=site[1], rotation=angle)
